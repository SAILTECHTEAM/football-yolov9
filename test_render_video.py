...
if __name__ == "__main__":
    ...
    start_frame = 62059
    end_frame = 62086
    suspicious_track_ids = ["9592b"]  # Optional: IDs to highlight in the video

    bg_img = cv2.imread(background_image_path)
    bg_img = cv2.resize(bg_img, field_size)
    # Call the function to render the video
    render_to_video_from_jsonl(jsonl_file_path, bg_img, field_size, output_video_path, 29.97, start_frame, end_frame, suspicious_track_ids)
